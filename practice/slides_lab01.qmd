...
+  (make sure to replace the file path `here(...)` according to *your own* folder structure)
...
⚠️ WARNING︎: This is a very delicate step️ ⚠️  
...
In this case I have added the median line.
...
1. We create the `highlight` variable
2. We map color to a variable (`fill = highlight`)
