...
I developed this course with the help of [Luisa M. Mimmi](https://luisamimmi.org/) (my sister!), who co-created the practice labs and built this website.

We are genuinely grateful to many people within the Biostatistics, Epidemiology and R programming communities, who shared their valuable work and teaching materials. Below is a curated list of great resources (many of which free and openly accessible) you can peruse on your own. 
...
The workshop materials are licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/). All borrowed external materials (images, examples, etc.), are credited with proper "*Source:*" statements and governed by their own licenses. We mostly drew from sources that were published under "open access" or "creative commons" frameworks. If this were not the case for any content piece displayed here, please let us know and we will remove it.
