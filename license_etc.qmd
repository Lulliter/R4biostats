...
I developed this course with a major contribution from [Luisa M. Mimmi](https://luisamimmi.org/) (my sister!), who co-created the practice labs and built this website.
...
We would love to hear your feedback, questions, or suggestions about the workshop:  <p> <a id="mail-link" href="mailto:lmm76@georgetown.edu"  class="btn btn-info"> <i class="fa fa-envelope"></i> &nbsp;&nbsp;contact us</a></p>

## Licensing and use of the course materials

The course materials are licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/). All borrowed external materials (images, examples, etc.), are credited with proper "*Source:*" statements and governed by their own licenses. We drew from sources that were published under "open access" or "creative commons" frameworks. If this were not the case for any of material displayed here, please let us know and we will remove it.
