...
We would love to hear your feedback, questions, or suggestions about the workshop materials:  <p> <a id="mail-link" href="mailto:lmm76@georgetown.edu"  class="btn btn-info"> <i class="fa fa-envelope"></i> &nbsp;&nbsp;contact us</a></p>
...
mybib_df %>% 
  filter(!(include %in% "no") & type == "YT course") %>% 
   select(key)
...
<!-- + @academic_lessons_biostatistics_2024 -->
