...
Beyond with **conceptual foundations**, participants engage in **hands-on coding sessions** in the R software with real-world datasets and solved questions, validating in practice the skills needed to confidently acquire and communicate insights throughout the analytical process.   
...
Detailed [instructions](https://r4biostats.com/install.html) are provided to complete the required installation of R and RStudio ahead of the workshop, if the participants want to follow along the practical coding modules.
