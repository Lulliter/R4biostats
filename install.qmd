...
+ Beware, R may ask you to install some related packages (`dependencies`): follow instructions by responding directly in the R console. 
```{r}
#| eval: false
#| echo: true

# Installing (**ONLY** the 1st time you use them)
pkg_list <- c("here", "fs", "janitor", "skimr","openxlsx","flextable",
              "dplyr", "tidyr","forcats", 
              "ggplot2", "ggstatsplot", "ggpubr", "patchwork", "viridis",
              "ggthemes" ,"ggridges", 
              "BSDA", "rstatix", "car", "multcomp", "lmtest" , "broom", 
              "performance" )
