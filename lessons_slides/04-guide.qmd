...
auto_zulassung_kraftstoff <- 
  rio::import(here::here("lessons_slides", "data", "5_abb_entwicklung-pkw-neuzulass-kraftstoffart_2023-04-28.xlsx"), skip = 8) |> 
  tibble::as_tibble() |> 
  janitor::clean_names() |> 
...
data <- 
  readr::read_csv(here::here("lessons_slides", "data", "carbon-footprint-travel.csv")) |> 
